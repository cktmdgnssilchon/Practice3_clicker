...
public class UIImageButtonInspector : Editor
{
	...
	void OnNormal (string spriteName)
	{
        ...
        if (mButton.gameObject.GetComponent<Collider>() == null || (mButton.gameObject.GetComponent<Collider>() is BoxCollider)) NGUITools.AddWidgetCollider(mButton.gameObject);
		Repaint();
	}
